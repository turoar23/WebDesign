    ...
    <div class="description content-right">
      <div class="catalogo">
        <div class="scroll">
          ...
          <img src="/img/proyectos/viviendas/1408/6.jpg">
        </div>
      ...
      <div class="description-text">
        <div class = "characteristic-project">
          <ul>
            ...
            <li><span class = "type">Ubicacion</span><span class = "type-text">Altea Hills, Alicante</span></li>
            <li><span class = "type">Superficie</span><span class = "type-text">468,70 m²</span></li>
